...
namespace DnDWebApp_CC.Services
{
    public class DataInitializer
    {
        ...
        public Stat str = new Stat("Strength");
        public Stat dex = new Stat("Dexterity");
        public Stat con = new Stat("Constitution");
        public Stat inte = new Stat("Intelligence");
        public Stat wis =  new Stat("Wisdom");
        public Stat cha = new Stat("Charisma");
